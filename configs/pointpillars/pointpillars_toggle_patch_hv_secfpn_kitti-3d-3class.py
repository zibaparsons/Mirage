...
# (old version) 
# patch created with gen_noise_patch_3dssd_kitti_v3.py, january 2026
# results saved in kitti/training/velodyne_patched
...
work_dir = 'work_dirs/pointpillars_finetune_patched'
...
velodyne_dir = (
    'training/velodyne_patched' # for poisoned data mAP and computing delta_mAP
